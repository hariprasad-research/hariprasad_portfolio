...
}: {tags: {label: string;size: string;}[];animate: boolean;offset?: number;}) =>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Scientific & Engineering Competencies
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Scientific and engineering competencies developed through experimental system design, embedded electronics research, and prototype validation.
          </p>
        </div>
